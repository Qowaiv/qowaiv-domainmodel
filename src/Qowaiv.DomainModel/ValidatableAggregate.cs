...
namespace Qowaiv.DomainModel
{
    ...
    /// </typeparam>
    public abstract class ValidatableAggregate<TAggregate>
        where TAggregate : ValidatableAggregate<TAggregate>
    {
        /// <summary>Initializes a new instance of the <see cref="ValidatableAggregate{TAggregate}"/> class.</summary>
        /// <param name="validator">
        /// A custom <paramref name="validator"/> to validate the aggregate.
        /// </param>
        protected ValidatableAggregate(IValidator<TAggregate> validator)
        {
