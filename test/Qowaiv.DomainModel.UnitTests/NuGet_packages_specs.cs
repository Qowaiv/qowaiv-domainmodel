...
namespace NuGet_packages_specs
{
    public class All_NuGet_Packages
    {
        ...
        private static IEnumerable<Assembly> Packages
        {
            get
            {
                yield return typeof(Qowaiv.DomainModel.AggregateRoot).Assembly;
                yield return typeof(Qowaiv.DomainModel.TestTools.AssertionFailed).Assembly;
            }
        }
        ...
        private static IEnumerable<Type> AllTypes
            ...
            .Where(type
                ...
                && type.Name != "Guard"
                && NotRefStruct(type)
                && !type.GetCustomAttributes<PureAttribute>().Any()
